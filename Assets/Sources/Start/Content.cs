...
public class Content
{
   ...
   public static Content[] contents = {
       new() { playerType = PlayerType.Ringmaster, text = "Ladies and gentlemen, children, welcome to the thrilling 'Happy Show'! " },
        ...
        new() { playerType = PlayerType.Ringmaster, text = "So, please, sit back, relax, and let our performers create an unforgettable night with their courage and talent." },
        new() { playerType = PlayerType.Ringmaster, text = "Don't wait any longer! Let our show, the 'Happy Show,' completely captivate you! Get ready to be conquered by us!" },
        
        new() { action = CanvasAction.ChangeSceneTo1 },

      //   幕后
        
        new() { playerType = PlayerType.Ringmaster, text = "Listen up, Mr. M and Mr. E, tonight's performance better not disappoint me! The audience needs laughter, and if you can't deliver, you'll deal with the consequences!" },
        new() { playerType = PlayerType.Player1, text = "Ringmaster, we'll do our best, but safety—" },
        new() { playerType = PlayerType.Ringmaster, text = "Safety? You're clowns; making the audience happy is your only job! Don't give me excuses; I..." },
        new() { playerType = PlayerType.Ringmaster, text = "Oh, wait, my dear children, today is an important day. I should reward you, shouldn't I? Let me think... maybe it's time for you to leave?" },
